        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center mb-16">
            <Link to="/" className="flex items-center gap-2 mb-8 group">
              <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center transition-transform group-hover:scale-110">
                <span className="text-2xl">🌱</span>
              </div>
              <span className="text-xl font-semibold text-gray-900">EcoTail</span>
            </Link>
            <div className="flex gap-8">
              <a href="https://twitter.com/ecotail" className="text-gray-400 hover:text-gray-600 transition-colors">
              ...
              <a href="https://github.com/ecotail" className="text-gray-400 hover:text-gray-600 transition-colors">
              ...
              <a href="https://linkedin.com/company/ecotail" className="text-gray-400 hover:text-gray-600 transition-colors">
          ...
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <Link to="/ai-innovations" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    AI Innovations
                  </Link>
                </li>
                <li>
                  <Link to="/clean" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Clean
                  </Link>
                </li>
                <li>
                  <Link to="/bins" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Smart Bins
                  </Link>
                </li>
                <li>
                  <Link to="/education" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Education
                  </Link>
                </li>
              </ul>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <Link to="/by-self-labs" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    By Self Labs
                  </Link>
                </li>
                <li>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li>
                  <Link to="/help" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Help Center
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    FAQs
                  </Link>
                </li>
              </ul>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-6 space-y-4">
                <li>
                  <Link to="/privacy" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link to="/terms" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Terms of Service
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/compliance" className="text-base text-gray-600 hover:text-gray-900 transition-colors">
                    Compliance
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-16 border-t border-gray-100 pt-8">
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
              ...
              <div className="flex gap-x-8">
                <Link to="/accessibility" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  Accessibility
                </Link>
                <Link to="/sitemap" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  Sitemap
                </Link>
