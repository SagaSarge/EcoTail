        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-96 h-96 bg-primary-100 rounded-full opacity-20 blur-3xl transform -rotate-12" />
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
                <div className="aspect-w-4 aspect-h-5 bg-gray-100 rounded-2xl overflow-hidden">
                  ...
                  <div className="p-6 flex flex-col items-center justify-center text-gray-500">
                    <div className="w-full h-64 bg-gray-200 rounded-xl mb-4 relative">
                      {/* Bin Design */}
                      <div className="absolute inset-x-8 top-4 bottom-4 bg-primary-100 rounded-lg">
                        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-12 h-2 bg-primary-200 rounded-full" />
                        {/* Animated Scanner Effect */}
                        <div className="absolute inset-x-0 h-1 bg-primary-400 rounded-full animate-scan" 
                ...
                <div className="mt-6 grid grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-primary-600">0.5s</div>
              ...
              <div className="absolute -right-8 -bottom-12 transform rotate-12">
                <div className="bg-white rounded-2xl shadow-lg p-4">
                  <div className="text-sm font-semibold text-gray-900">Real-time Alert</div>
